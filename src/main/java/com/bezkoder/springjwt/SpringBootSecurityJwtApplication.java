...
public class SpringBootSecurityJwtApplication {
	...
	public void init() {
		...
		Course course3 = new Course(10104, 302, 35, new Date(term2.getYear() -1900, 8, 15) ,  new Date(term2.getYear() -1900, 11, 20), teacher1, room1, term2);
		Course course5 = new Course(10105, 401, 35, new Date(term2.getYear() -1900, 8, 15) ,  new Date(term2.getYear() -1900, 11, 20), teacher1, room1, term2);
