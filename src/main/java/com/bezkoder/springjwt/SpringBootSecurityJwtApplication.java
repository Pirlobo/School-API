...
public class SpringBootSecurityJwtApplication {
	...
	public void init() {
		...
		Subject subject2 = new Subject(2, SubjectName.Computer_Science, SubjectCode.COMSC_75, null, description_comsc_75);
		subjectRepository.save(subject2);
		Subject subject = new Subject(1, SubjectName.Computer_Science, SubjectCode.COMSC_76, subject2, description_comsc_76);
		subjectRepository.save(subject);
		Subject subject3 = new Subject(3, SubjectName.Computer_Science, SubjectCode.COMSC_77, subject2, description_comsc_77);
